...
// //     if (this.$cursor.data.selectedItem === this.items[0] && distance === -1) {
// //       nextIndex = this.$items.children.length - 1;
// //     } else if (
// //       this.$cursor.data.selectedItem === this.items[this.items.length - 1] &&
// //       distance === 1
// //     ) {
// //       nextIndex = 0;
// //     } else {
// //       const selectedIndex = this.$items.children.findIndex(
// //         (opt) => (opt as TextObject).text === this.$cursor.data.selectedItem
// //       );
